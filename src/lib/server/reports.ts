...
// Default to the reports database in the report_pipeline directory
const DEFAULT_DB_PATH = './report_pipeline/reports.db';

let db: Database.Database | null = null;

function getDatabase(): Database.Database {
    if (!db) {
        const dbPath = RANKED_VOTE_REPORTS_DB || DEFAULT_DB_PATH;
